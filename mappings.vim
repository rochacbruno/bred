...
" ,bl - List buffers and jump to one
nnoremap [q :bp<CR>
" [q  - Previous buffer
nnoremap ]q :bn<CR>
" ]q  - Next buffer
...
" ,<Tab> - Toggle between two buffers
...
" ,rs - Enter resize mode (arrows to resize)
" }}}
"
" -------------------------------------------------------------------------
...
" C-v Esc - Exit terminal mode
nnoremap <leader>c :botright term<CR>
" ,c      - Open terminal at bottom
" }}}
" -------------------------------------------------------------------------
" Search and Replace
" -------------------------------------------------------------------------
...
" Alt+j - Move line down (insert)
inoremap <M-k> <Esc>:m .-2<CR>==gi
" Alt+k - Move line up (insert)
xnoremap <M-j> :m '>+1<CR>gv=gv
" Alt+j - Move selection down (visual)
xnoremap <M-k> :m '<-2<CR>gv=gv
" Alt+k - Move selection up (visual)
" Using Alt+Arrow keys
nnoremap <M-Down> :m .+1<CR>==
" Alt+Down - Move line down (normal)
nnoremap <M-Up> :m .-2<CR>==
" Alt+Up - Move line up (normal)
inoremap <M-Down> <Esc>:m .+1<CR>==gi
" Alt+Down - Move line down (insert)
inoremap <M-Up> <Esc>:m .-2<CR>==gi
" Alt+Up - Move line up (insert)
xnoremap <M-Down> :m '>+1<CR>gv=gv
" Alt+Down - Move selection down (visual)
xnoremap <M-Up> :m '<-2<CR>gv=gv
" Alt+Up - Move selection up (visual)
...
xnoremap p "_dP
" p - Paste in visual mode without yanking
vnoremap p "_dP
" p - Paste in visual mode without yanking
" }}}
...
" -------------------------------------------------------------------------
nnoremap Q <Nop>
" Q - Disable Ex mode (often hit by accident)
